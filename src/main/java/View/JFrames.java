...
public class JFrames extends javax.swing.JFrame {
    ...
    GameUtils helper = new GameUtils();
    ...
    public JFrames() {
        ...
        items[0] = new InventoryItem("Малое зелье лечение", 0);
        items[1] = new InventoryItem("Большое зелье лечение", 0);
        items[2] = new InventoryItem("Крест возрождения", 0);
